...
\begin{tabular}{ >{\hfill}p{0.132\textwidth} p{0.822\textwidth} }
\gray {\scshape Employer} & \textbf{Partners in Enterprise Ltd} \hfill Zagreb, Croatia (remote) \\
\gray {\scshape Period} & \textbf{September 2011 --- October 2015} (4 years) \hfill London, United Kingdon \\
\gray {\scshape Job Title} & \textbf{Technology Partner} (part-time)\\
\tablerule & Provided technical expertise in evaluating, estimating, architecting, building and maintaining white label projects for Android, iOS, BlackBerry 10 and the web in the broadcasting industry.
\end{tabular}
